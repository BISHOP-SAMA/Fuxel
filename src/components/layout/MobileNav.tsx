...
import { LayoutDashboard, ShieldAlert, Ticket, Activity, Coins, MessageSquare, UserCircle, Trophy, X, LogOut } from "lucide-react";
...
export function MobileNav({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      {/* Drawer */}
      <div className="absolute left-0 top-0 bottom-0 w-72 bg-[#0a0a0c] border-r border-amber-500/10 flex flex-col">
        <div className="h-16 flex items-center justify-between px-6 border-b border-amber-500/10">
          <div className="flex items-center gap-3">
            <div className="h-7 w-7 rounded bg-amber-500 overflow-hidden">
